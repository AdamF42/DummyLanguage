...
public class ComplexStaticAnalysisParser extends Parser {
	...
	public static final int
		...
		ID=26, WS=27, LINECOMMENTS=28, BLOCKCOMMENTS=29, ERR=30;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			"ROP", "INTEGER", "ID", "WS", "LINECOMMENTS", "BLOCKCOMMENTS", "ERR"
		};
	}
	...
	public static class FunDecContext extends DeclarationContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).enterFunDec(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).exitFunDec(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ComplexStaticAnalysisVisitor ) return ((ComplexStaticAnalysisVisitor<? extends T>)visitor).visitFunDec(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class VarDecContext extends DeclarationContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).enterVarDec(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).exitVarDec(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ComplexStaticAnalysisVisitor ) return ((ComplexStaticAnalysisVisitor<? extends T>)visitor).visitVarDec(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IntValueContext extends ValueContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).enterIntValue(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).exitIntValue(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ComplexStaticAnalysisVisitor ) return ((ComplexStaticAnalysisVisitor<? extends T>)visitor).visitIntValue(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BoolValueContext extends ValueContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).enterBoolValue(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).exitBoolValue(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ComplexStaticAnalysisVisitor ) return ((ComplexStaticAnalysisVisitor<? extends T>)visitor).visitBoolValue(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class IdValueContext extends ValueContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).enterIdValue(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).exitIdValue(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ComplexStaticAnalysisVisitor ) return ((ComplexStaticAnalysisVisitor<? extends T>)visitor).visitIdValue(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ExpValueContext extends ValueContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).enterExpValue(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).exitExpValue(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
